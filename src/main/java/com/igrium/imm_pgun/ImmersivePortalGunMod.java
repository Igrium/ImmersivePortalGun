...
import com.igrium.imm_pgun.test.PortalColorArgumentType;
...
public class ImmersivePortalGunMod implements ModInitializer {
    ...
    public static enum PortalColor implements StringIdentifiable {
        BLUE(ColorHelper.Argb.getArgb(255, 23, 100, 255)),
        ORANGE(ColorHelper.Argb.getArgb(255, 255, 107, 15));

        @SuppressWarnings("deprecation")
        public static final Codec<PortalColor> CODEC = StringIdentifiable.createCodec(PortalColor::values);
